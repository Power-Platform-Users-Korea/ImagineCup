...
**이 서비스는 AI 기반 정보 제공 도구이며, 전문적인 법률 자문을 대체하지 않습니다.**

- ✅ **일반적인 정보 제공**: 실업급여 제도, 노동법 기본 안내
- ✅ **긴급 대응 가이드**: 위험 상황에서 즉시 취할 행동 안내
- ✅ **전문가 연계**: 무료 법률 지원 기관 정보 제공

- ❌ **법률 자문 불가**: 개별 사례에 대한 법률적 판단은 전문가에게 문의하세요
- ❌ **소송 대리 불가**: 법적 절차는 변호사/노무사와 상담 필요
...
graph TB
    subgraph "사용자 레이어"
        A[👤 노동자<br/>웹/모바일 인터페이스]
    end

    subgraph "Azure Cloud"
        B[🌐 Azure Container Apps<br/>프론트엔드 웹]
        C[⚙️ Azure Container Apps<br/>Flask API 백엔드]
        D[🤖 Azure OpenAI Service<br/>GPT-4]
        E[(📚 노동법 데이터베이스<br/>고용보험법, 노동기준법,<br/>대법원 판례)]
    end
...
**이 정보는 2025년 1월 기준입니다. 법률은 변경될 수 있으므로 최신 정보는 전문가와 확인하세요.**
```
...
> **참고**: 아래 수치는 2024년 보도 자료 및 정부 통계를 기반으로 한 추정치입니다.

### 쿠팡 사례에 적용했다면 (추정)

**실제 상황** (2024):
- 영향 받은 노동자: 약 1,000+ 명 (언론 보도 기준)
- 실업급여 미수령 추정액: 약 ₩500,000,000+
...
**연간 추정**:
- 부당 퇴사 강요 피해자: 약 10,000+ 명 (고용노동부 추정)
- 실업급여 미수령 총액: 약 ₩5,000,000,000
- **AI 도입 시 구제 가능 인원: 약 7,000+ 명 (70% 성공률 가정)**
...
> **참고**: ROI는 보호된 실업급여의 총액 기준이며, 직접적인 수익이 아닌 사회적 가치를 나타냅니다.

**월 ₩50,000 운영비 투자 시** (추정):
- 노동자 100명 상담 가능 (Azure OpenAI 사용량 기준)
- 평균 실업급여액: ₩1,500,000 x 120일 = ~₩180,000,000
- **사회적 ROI: 360,000%** (보호된 급여 총액 / 운영비)

*실제 운영비는 사용량에 따라 변동될 수 있습니다.*
...
## 🎯 Imagine Cup 2026 - Financial Services 부문

**카테고리**: Financial Services (금융 서비스)

**도전 과제**: 실업급여 박탈을 통한 경제적 불평등

취약한 노동자들은 복잡한 노동법 정보 격차로 인해 정당한 실업급여를 받지 못하고 있습니다. 이는 곧 개인의 경제적 안정성과 재정적 보안을 위협하는 금융 서비스 접근성 문제입니다.

**혁신 솔루션**: AI를 통한 금융 권리 보호 민주화

- 복잡한 노동법을 24/7 접근 가능한 실시간 상담 서비스로 전환
- Azure OpenAI를 활용한 맞춤형 권리 안내
- 정보 비대칭 해소를 통한 금융 보안 강화

**사회적 영향**: 노동자 경제적 안전망 보호

- 연간 추정 10,000+ 명의 노동자 지원
- 약 ₩5,000,000,000 규모의 실업급여 보호
- 취약 계층의 금융 안정성 향상

**기술 스택**: Azure OpenAI, Azure Container Apps, Python/Flask
